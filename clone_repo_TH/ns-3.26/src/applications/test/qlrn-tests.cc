...
void QLearnerBasicShortTestCase::DoRun (void) {
  ...
  NS_TEST_ASSERT_MSG_EQ ( obj.ConfigureTest ( true /* pcap */, false /*printRoutes*/, false /*ideal*/,
                              false /*linkBreak*/, 0 /* numHops */, false,
  ...
  std::vector<std::array<int, 3> > expected_results { {999,4,2}, {6,4,0}, {3,3,2} } ; //999 should really be 3
...
void QLearnerBasicMediumTestCase::DoRun (void) {
  QLearningBase obj;
  NS_TEST_ASSERT_MSG_EQ (obj.ConfigureTest ( false /* pcap */, false /*printRoutes*/, false /*linkBreak*/, false /*ideal*/,false,
                                         0 /* numHops */, "test0.txt"/* test_case_filename */, ""  ),
                                        true,  "Configuring failed for test." );
...
void QLearnerFourNodesICMPTestCase::DoRun (void) {
  QLearningBase obj;
  NS_TEST_ASSERT_MSG_EQ (obj.ConfigureTest ( false /* pcap */, false /*printRoutes*/,false /*linkBreak*/, false /*ideal*/,false,
                                         0 /* numHops */, "test1.txt"/* test_case_filename */, "" ),
                                       true, "Configuring failed for test." );
...
void QLearnerFiveNodesICMPTestCase::DoRun (void) {
  QLearningBase obj;
  NS_TEST_ASSERT_MSG_EQ (obj.ConfigureTest ( false /* pcap */, false /*printRoutes*/,false /*linkBreak*/, false /*ideal*/,false,
                                         0 /* numHops */,"test2.txt"/* test_case_filename */, "" ),
                                       true, "Configuring failed for test." );
