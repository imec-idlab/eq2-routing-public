      ...
      if (entry->IsExpired ())
      ...
      else
        {
          if (entry->IsDead ())
            {
              NS_LOG_DEBUG ("node="<<m_node->GetId ()<<
                            ", dead entry for " << destination << " valid -- drop"<<packet->GetUid() << "  ");
            ...
            {
              NS_LOG_DEBUG ("node="<<m_node->GetId ()<<
                            ", alive entry for " << destination << " valid -- send  " << packet->GetUid());
            ...
            {
              NS_LOG_DEBUG ("node="<<m_node->GetId ()<<
                            ", wait reply for " << destination << " valid -- drop previous  " << packet->GetUid());
