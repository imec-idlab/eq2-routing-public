...
public:
  ...
  struct TagData
  {
    ...
    enum TagData_e
    {
      // https://www.nsnam.org/bugzilla/show_bug.cgi?id=2221 Changed to 28 because thats how much I need
      // but seems problematic as it requires a rebuild of (almost) the entire ns3 thing..
